<?php
     ...
     * Time: 10:32 AM
     */
    function render_the_upcoming_webinars($theStuff)
    {
        ob_start();
        ...
        <div class="webinarContent">
            ...
            <!---->
            <!--    <h4 style="margin-bottom: 8%; ">--><?php //echo $theStuff['channel']['description']; ?><!--</h4>-->
            <!--    <h5>--><?php //echo $theFeed['channel']['managingEditor']; ?><!--</h5>-->
            <?php
                ...
                foreach ($theStuff['channel']['item'] as $article)
                {
                    ...
                    if ($publicationDate > $today) {
                        ...
                        <div class="webinarMeta"><?php echo $theStuff['channel']['title'] . ' | ' . $publicationDate; ?></div>
                        <p>
                            <br/>
                            <?php echo $article['description']; ?>
                            <?php //echo $article['comments']; ?>
                            <a style="text-decoration: none; font-weight: bold;" href="<?php echo $article['signupUrl']; ?>"> Watch Webinar ></a>
                        </p>
                        </div><?php
                    }
                }
